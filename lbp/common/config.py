...
cmd_opt.add_argument('--n_train', type=int, default=1)
...
cmd_opt.add_argument('--ess_ratio', type=float, default=0.8)
cmd_opt.add_argument('--burn_in', type=float, default=.5)
cmd_opt.add_argument('--ess_statistic', type=str, default="dims", choices=["hamming", "dims"])

# for ising
cmd_opt.add_argument('--p', type=int, default=50)
cmd_opt.add_argument('--mu', type=float, default=.1)
cmd_opt.add_argument('--sigma', type=float, default=.1)
cmd_opt.add_argument('--lamda', type=float, default=.1)
...
# for rbm sampling
cmd_opt.add_argument('--mu_v', type=float, default=5.0)
cmd_opt.add_argument('--mu_h', type=float, default=5.0)

# for sampler
cmd_opt.add_argument('--U', type=int, default=3)
cmd_opt.add_argument('--no_refresh', type=int, default=0)
cmd_opt.add_argument('--tau', type=float, default=2.0)
cmd_opt.add_argument('--g_func', type=str, default='sqrt2')


# for adaptive
cmd_opt.add_argument('--rate_stats', type=str, default='exp-0.9')
cmd_opt.add_argument('--adaptive_sampling', action='store_true')
